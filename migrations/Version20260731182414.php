...
final class Version20260731182414 extends AbstractMigration
{
    ...
    {
        return 'Create the equipment catalogue and its pricing rates.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, pricing_model VARCHAR(20) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE pricing_rate (id INT AUTO_INCREMENT NOT NULL, duration_in_days INT DEFAULT NULL, amount INT NOT NULL, equipment_id INT NOT NULL, INDEX idx_pricing_rate_equipment (equipment_id), UNIQUE INDEX uniq_pricing_rate_duration (equipment_id, duration_in_days), PRIMARY KEY (id), CONSTRAINT chk_pricing_rate_duration CHECK (duration_in_days IS NULL OR duration_in_days > 0), CONSTRAINT chk_pricing_rate_amount CHECK (amount >= 0)) DEFAULT CHARACTER SET utf8mb4');
